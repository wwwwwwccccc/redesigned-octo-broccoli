window.onload = function () {
    var aData = [{
        "imgUrl": "image/shouban1.jpg",
        "proName": " 熊猫镜 ",
        "proPrice": "66",
        "proComm": "121"
    },
    {
        "imgUrl": "image/shouban2.jpg",
        "proName": " 可爱熊猫 ",
        "proPrice": "50",
        "proComm": "208"
    },
    {
        "imgUrl": "image/shouban3.jpg",
        "proName": " 交大校宠 ",
        "proPrice": "99",
        "proComm": "300"
    },
    {
        "imgUrl": "image/shouban4.jpg",
        "proName": " ‘虎虎生威’ ",
        "proPrice": "111",
        "proComm": "250"
    },
...
function getAmount() {
    ...
    //     document.getElementById("price_num").innerText = sum;
    // }
   var sum= carData.reduce(function (pre,cur){
       if(cur.checked){
        pre+=cur.num*cur.proPrice
       }
       return pre
    },0)
    document.getElementById("price_num").innerText = sum;
